...
public class TunerConstants {
  ...
  private static final SwerveModuleConstants<
      ...
      module_1 =
          ConstantCreator.createModuleConstants(
              2, 3, 1, 0.0, 0, 0, true, false, false);

  private static final SwerveModuleConstants<
          TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
      module_2 =
          ConstantCreator.createModuleConstants(
              4, 5, 2, 0.0, 0, 0, false, false, false);

  private static final SwerveModuleConstants<
          TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
      module_3 =
          ConstantCreator.createModuleConstants(
              6, 7, 3, 0.0, 0, 0, true, false, false);

  private static final SwerveModuleConstants<
          TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
      frontLeft =
          module_0
              .withLocationX(frontLeftPos.getX())
              .withLocationY(frontLeftPos.getY());
  private static final SwerveModuleConstants<
          TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
      frontRight =
          module_1
              .withLocationX(frontRightPos.getX())
              .withLocationY(frontRightPos.getY());
  private static final SwerveModuleConstants<
          TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
      backLeft =
          module_2
              .withLocationX(backLeftPos.getX())
              .withLocationY(backLeftPos.getY());
  private static final SwerveModuleConstants<
          TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
      backRight =
          module_3
              .withLocationX(backRightPos.getX())
              .withLocationY(backRightPos.getY());
