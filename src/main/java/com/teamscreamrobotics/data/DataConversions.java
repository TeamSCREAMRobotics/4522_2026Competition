...
public class DataConversions {
  ...
  /**
   * Converts a {@link Translation3d} to a 7-element array {@code [x, y, z, 0, 0, 0, 0]} (position
   * only, quaternion zeroed).
   *
  ...
  /**
   * Converts a {@link Translation3d} and {@link Rotation3d} to a 7-element pose array {@code [x, y,
   * z, qx, qy, qz, qw]}.
   *
  ...
  public static double[] chassisSpeedsToArray(ChassisSpeeds speeds) {
    return new double[] {speeds.vx, speeds.vy, speeds.omega};
  }

  /**
   * Projects a {@link Translation3d} onto the XZ plane, returning {@code (x, z)} as a {@link
   * Translation2d}.
   *
