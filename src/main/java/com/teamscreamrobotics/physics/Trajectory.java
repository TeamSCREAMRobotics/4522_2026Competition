...
/**
 * Trajectory calculator for projectile motion with air resistance Designed for scoring with a ball
 *
 * <p>Usage: Trajectory.configure() .setShotVelocity(12.0) .setShotAngle(45.0)
 * .setTargetDistance(4.0) .setGamePiece(GamePiece.FUEL);
 *
 * <p>List<TrajectoryPoint> path = Trajectory.getDesiredTrajectory(); double angle =
 * Trajectory.getOptimalAngle();
 */
public class Trajectory {
  ...
  public static class TrajectoryConfig {
     ...
     */
    public TrajectoryConfig setCustomGamePiece(
        double massKg, double diameterMeters, double dragCoefficient) {
     ...
     */
    public TrajectoryConfig setCustomGamePieceImperial(
        double massLbs, double diameterInches, double dragCoefficient) {
  ...
  public static class TrajectoryPoint {
    ...
    public String toString() {
      return String.format("t=%.3f, x=%.3f, y=%.3f, vx=%.3f, vy=%.3f", time, x, y, vx, vy);
    }
  }
  ...
  private static List<TrajectoryPoint> calculateTrajectory(
    ...
    double vx0 = shotVelocity * Math.cos(shotAngleRad) + robotVelocity * Math.cos(robotAngleRad);
    double vy0 = shotVelocity * Math.sin(shotAngleRad) + robotVelocity * Math.sin(robotAngleRad);
