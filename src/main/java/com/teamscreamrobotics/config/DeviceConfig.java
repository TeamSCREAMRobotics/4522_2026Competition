...
public class DeviceConfig {
  ...
  /**
   * Builds a {@link ClosedLoopGeneralConfigs} with continuous wrap enabled or disabled. Enable for
   * mechanisms that rotate continuously (e.g. swerve steer); disable for limited-range arms.
   *
  ...
  /**
   * Builds a {@link SoftwareLimitSwitchConfigs} that applies the same enable state to both
   * directions.
   *
