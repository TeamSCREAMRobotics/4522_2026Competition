...
/**
 * A named group of {@link Ligament}s forming a kinematic chain for {@link MechanismVisualizer}. The
 * first ligament is anchored at a root; subsequent ones chain from their predecessor unless {@link
