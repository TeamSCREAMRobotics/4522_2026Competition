...
/**
 * A WPILib subsystem that periodically updates one or more {@link Mechanism}s and publishes their
 * measured and setpoint {@link Mechanism2d} widgets via a telemetry consumer.
 */
public class MechanismVisualizer extends SubsystemBase {
   ...
   * @param setpointMechanism the {@link Mechanism2d} widget for setpoint state (typically logged
   *     green)
