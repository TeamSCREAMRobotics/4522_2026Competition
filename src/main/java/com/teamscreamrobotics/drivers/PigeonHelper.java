...
public class PigeonHelper {
  ...
  /** Get all velocity values at once Returns array: [velocityX, velocityY, velocityZ] */
  public double[] getAllVelocities() {
    ...
    return new double[] {
      velocityX.getValueAsDouble(), velocityY.getValueAsDouble(), velocityZ.getValueAsDouble()
    };
  }
