...
public class IKSolver {
  ...
  /**
   * Solves for the joint angles needed to reach {@code target}. If the target is outside the arm's
   * reachable range it is clamped to the nearest reachable point.
   *
